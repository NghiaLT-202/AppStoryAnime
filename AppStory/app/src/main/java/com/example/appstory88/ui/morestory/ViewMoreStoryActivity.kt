    ...
    private fun initAdapter() {
        ...
        storyAdapter = StoryAdapter().apply {
            ...
            val story = Story(
                ...
                2,
                "Tuấn Nghĩa",
                "Kiếm hiệp",1000,true,"Hãy bước vào thế giới kỳ diệu của giấy in nhiệt, nơi mà sự hài hước và sự tò mò gặp gỡ để tạo nên những trải nghiệm độc đáo. Có ai đó đã nghĩ ra ý tưởng tuyệt vời này: viết nội dung trên giấy, rồi chờ đợi một phép màu xảy ra.\n" +
                        "\n" +
